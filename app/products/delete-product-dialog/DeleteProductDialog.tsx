            ...
            <DialogHeader>
              <DialogTitle className="flex items-center gap-3">
                ...
                <span className="flex flex-col">
                  <span className="text-base font-semibold tracking-tight">Delete Product</span>
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <div className="rounded-lg border border-destructive/20 bg-destructive/5 p-4">
                <p className="text-sm text-foreground">
                  ...
                  <span className="font-semibold text-destructive">"{productName}"</span>?
                </p>
              </div>
              <p className="text-xs text-muted-foreground">
                This product will be permanently removed from your catalog and cannot be recovered.
              </p>
            </motion.div>
          </div>
